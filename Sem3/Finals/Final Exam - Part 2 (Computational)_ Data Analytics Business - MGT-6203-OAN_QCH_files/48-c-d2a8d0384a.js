(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[48],{"40dz":function(e,t,o){"use strict"
o.r(t)
...
this.onEnter=()=>{this.props.isToggleable&&this.setState({mode:this.props.isLocked?y.ADMIN_WILLUNLOCK:y.ADMIN_WILLLOCK})}
this.onExit=()=>{this.props.isToggleable&&this.setState({mode:this.props.isLocked?y.ADMIN_LOCKED:y.ADMIN_UNLOCKED})}
this.state={}
this.toggleBtnRef=null
e.isToggleable?this.state.mode=e.isLocked?y.ADMIN_LOCKED:y.ADMIN_UNLOCKED:this.state.mode=e.isLocked?y.TEACH_LOCKED:y.TEACH_UNLOCKED}componentDidMount(){const e=Math.max(...Object.values(y).map(e=>e.label.length))
...
n=Object(c["a"])(j["a"],{tip:r,placement:"top",variant:"inverse",on:["hover","focus"]},void 0,this.props.breakpoints.miniTablet?Object(c["a"])(O["a"],{id:"lock-toggle-btn",elementRef:e=>this.toggleBtnRef=e,variant:_,onClick:this.props.onClick,onFocus:this.onEnter,onBlur:this.onExit,onMouseEnter:this.onEnter,onMouseLeave:this.onExit,"aria-pressed":this.props.isLocked},void 0,e||(e=Object(c["a"])(a,{})),t||(t=Object(c["a"])(E["a"],{},void 0,i)),o||(o=Object(c["a"])(B["a"],{},void 0,s))):Object(c["a"])(q["a"],{color:"primary"===_?_:null,onClick:this.props.onClick,onFocus:this.onEnter,onBlur:this.onExit,onMouseEnter:this.onEnter,onMouseLeave:this.onExit,"aria-pressed":this.props.isLocked,screenReaderLabel:s},void 0,l||(l=Object(c["a"])(a,{}))))}else n=Object(c["a"])("span",{className:"bpc__lock-no__toggle"},void 0,Object(c["a"])("span",{className:"bpc__lock-no__toggle-icon"},void 0,Object(c["a"])(a,{})),Object(c["a"])(L["a"],{size:"small"},void 0,i))
return Object(c["a"])("span",{className:"bpc-lock-toggle"},void 0,n)}}x.defaultProps={isToggleable:false,onClick:()=>{},breakpoints:{}}
const M=Object(I["a"])(x)
M.setupRootNode=x.setupRootNode
var R=M
...
this.renderLockToggle()}}},JGuX:function(e,t,o){"use strict"
var c=o("An8g")
var l=o("q1tI")
var a=o.n(l)
var i=o("17x9")
...
t["a"]=k},L2KU:function(e,t,o){"use strict"
...
//# sourceMappingURL=48-c-d2a8d0384a.js.map