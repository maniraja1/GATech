(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[4099],{bh89:function(e,t,a){"use strict"
a.r(t)
var i=a("ouhR")
var n=a.n(i)
var d=a("qqwe")
...
function E(e){n()(e).on("error",e=>{e.currentTarget.src?n.a.get(e.currentTarget.src,void 0,void 0,"text").fail(t=>{403===t.status?n()(e.currentTarget).attr({src:"/images/svg-icons/icon_lock.svg",alt:I.t("Locked image"),width:100,height:100}):n()(e.currentTarget).addClass("broken-image")}):n()(e.currentTarget).addClass("broken-image")})}function B(){Array.from(document.querySelectorAll('img:not([src=""])')).forEach(E)}n()(document).ready(()=>B())
const S=".lti-thumbnail-launch"
function T(e){e.preventDefault()
q.launch(n()(e.target).closest(S))}class A{constructor(){n()(document.body).delegate(S,"click",T)}launch(e){const t=JSON.parse(e.attr("target"))
const a=n()("<iframe/>",{src:e.attr("href"),allowfullscreen:"",width:t.displayWidth||500,height:t.displayHeight||500})
e.replaceWith(a)}}const q=new A(S)
var H=a("3lLS")
var N=a.n(H)
...
var J=a("TMMl")
Object(J["a"])()
ENV.page_view_update_url&&a.e(4101).then(a.bind(null,"4HNs"))
n()("#skip_navigation_link").on("click",Object(d["a"])((function(){n()(n()(this).attr("href")).attr("tabindex",-1).focus()})))}}])

//# sourceMappingURL=4099-c-4208576265.js.map