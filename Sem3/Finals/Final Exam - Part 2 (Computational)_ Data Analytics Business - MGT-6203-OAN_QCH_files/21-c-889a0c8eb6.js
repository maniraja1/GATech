...
e.attr("tabindex",-1)}}},Ce78J:function(e,t,i){"use strict"
var r=i("Vc0b")
var a=i("eodz")
...
function b(e){return e&&e.length?e:s()(e)}t["a"]=m},ErZx:function(e,t,i){"use strict"
...
t["a"]=r},JiFB:function(e,t,i){"use strict"
i.d(t,"a",(function(){return s}))
var r=i("VTBJ")
var a=i("uYtQ")
var n=i("ErZx")
const o=window.ENV.use_rce_enhancements
class s{constructor(e,t,i,r){this.formatBtnGroup="bold italic underline forecolor backcolor removeformat alignleft aligncenter alignright"
...
this.idAttribute=r}defaultConfig(){var e,t
const i=["instructure_equation"]
null!==(e=this.extraButtons)&&void 0!==e&&e.length&&i.push("instructure_external_tools")
return Object(r["a"])(Object(r["a"])({},n["a"]),{},{body_class:null!==(t=window.ENV.FEATURES)&&void 0!==t&&t.canvas_k6_theme||window.ENV.K5_SUBJECT_COURSE||window.ENV.K5_HOMEROOM_COURSE?"elementary-theme":"default-theme",selector:"#"+this.idAttribute,[!o&&"toolbar"]:this.toolbar(),[!o&&"theme"]:"modern",[!o&&"skin"]:false,directionality:Object(a["b"])(),plugins:o?i:"autolink,media,paste,table,lists,textcolor,link,directionality,a11y_checker,wordcount,instructure_image,instructure_links,instructure_equation,instructure_external_tools,instructure_record",content_css:window.ENV.url_to_what_gets_loaded_inside_the_tinymce_editor_css,menubar:!o||void 0,init_instance_callback:e=>{$("#tinymce-parent-of-"+e.id).css("visibility","visible")},show_media_upload:!!INST.kalturaSettings&&!INST.kalturaSettings.hide_rte_button})}external_buttons(){let e=""
...
return e}buildInstructureButtons(){let e=" instructure_image instructure_equation"+(o?" lti_tool_dropdown":"")
...
return o?[i,r,a]:[i,r,a].map(e=>e.split(" ").join(","))}toolbar(){const e=this.buildInstructureButtons()
...
i("8JEM")
const b=ENV.MAX_MRU_LTI_TOOLS||5
var k={buttonConfig(e,t){const i={title:e.name,classes:"widget btn instructure_external_tool_button"}
...
a=r.canvas_icon_class?`<i class='${Object(m["a"])(r.canvas_icon_class)}' data-tool-id='${r.id}'></i>`:`<img src='${Object(m["a"])(r.icon_url)}' data-tool-id='${r.id}'/>`
a+="&nbsp;"+Object(m["a"])(r.name)
e[a]=function(){i(r,t)}
...
var v=i("dDTa")
var y=i("eodz")
const w=function(e,t){this.id=e.id
...
return n()("#"+this.id)}
this.createLink=function(e,t,i){Object(y["d"])(this.getEditor(),"create_link",{url:e,classes:t,selectedContent:this.selectedContent,dataAttributes:i,selectionDetails:this.selectionDetails})}}
var x=w
var T=i("SdaB")
i("ESjL")
i("aq8L")
class E{fetchYouTubeTitle(e,t){const i=ENV.JWT
...
e.attr("data-preview-alt",i)}})}}const S=["instructure_scribd_file"]
const C=["instructure_scribd_file"]
const z=new WeakMap
function A(e){const t=e.closest("img").attr("src")
return"<img src='"+Object(m["a"])(t)+"'/>"}function F(e){e.nodeChanged()
return new x(e)}function B(e,t){let i=e.replace(/(auto_open|inline_disabled)/g,"")
t.find(".auto_show_inline_content").attr("checked")&&(i+=" auto_open")
t.find(".disable_inline_content").attr("checked")&&(i+=" inline_disabled")
return i}function j(e,t,i,r){const a=e.find("#instructure_link_prompt_form")
a.off("submit")
...
e.dialog("close")
t.createLink(o,l,c)
r.call()}))}function L(e){const t=F(e)
const i=t.getEditor()
...
Object(T["b"])("BookmarkService",(function(e){const t=r.data("editor")
...
Object(T["a"])(n()(this).data("service").service,e=>{n()("#instructure_link_prompt").dialog("close")
Object(y["d"])(t,"create_link",{title:e.title,url:e.url,classes:a})})}))
i.append(s)
...
var d=new RegExp("("+S.join("|")+")");(c.attr("class")||"").match(d)&&r.addClass("for_inline_content").find(".disable_enhancement").show()
d=new RegExp("("+C.join("|")+")");(c.attr("class")||"").match(d)&&r.addClass("for_inline_content_can_auto_show").find(".auto_show").show()
...
r.dialog({width:425,height:"auto",title:"Link to Website URL",open(){n()(this).find(".prompt").focus().select()}})}function R(e,t){R.counter=R.counter||0
true==t&&0!=R.counter?R.counter=(R.counter+1)%5:n()(e.getBody()).find("a").each((function(){const e=new E
const t=n()(this)
...
t.text()===t.attr("href")&&i<1&&e.titleYouTubeText(t)}}))}function P(e){if(z.get(e)||void 0===e.on)return
...
n()(this).remove()}))}))
e.on("change",()=>{R(e)})
e.on("SetContent",()=>{R(e,"contentJustSet")})
z.set(e,true)}var N={buttonToImg:A,prepEditorForDialog:F,buildLinkClasses:B,bindLinkSubmit:j,renderDialog:L,updateLinks:R,initEditor:P}
i("q1tI")
var O=i("i8i4")
var D=i.n(O)
const V={get more_external_tools(){return Object(m["a"])(p.t("more_external_tools","More External Tools"))}}
const I={init(e,t,r){N.initEditor(e)
if(!r||!r.editorButtons||!r.editorButtons.length)return
let a={open:(...e)=>setTimeout(()=>a.open(...e),50)}
Promise.all([i.e(1),i.e(3),i.e(4),i.e(6),i.e(16),i.e(2301)]).then(i.bind(null,"PrO8")).then(({default:t})=>{const i=document.createElement("div")
document.body.appendChild(i)
D.a.render(Object(_["a"])(t,{win:window,editor:e,contextAssetString:ENV.context_asset_string,iframeAllowances:Object(v["a"])(),resourceSelectionUrl:n()("#context_external_tool_resource_selection_url").attr("href"),deepLinkingOrigin:ENV.DEEP_LINKING_POST_MESSAGE_ORIGIN}),i,(function(){a=this}))})
const o=[]
const s=[]
for(let t=0;r.editorButtons&&t<r.editorButtons.length;t++){const i=r.editorButtons[t]
const n=()=>a.open(i)
if(ENV.use_rce_enhancements){s.push(k.buttonConfig(i,e))
...
e.addButton("instructure_external_button_"+i.id,k.buttonConfig(i,e))}}if(s.length&&ENV.use_rce_enhancements){H(e,s)
G(e,s)
U(e,s)
M(e,s)}if(o.length){const t=function(){const t=k.clumpedButtonMapping(o,e,e=>a.open(e))
k.attachClumpedDropdown(n()("#"+this._id),t,e)}
ENV.use_rce_enhancements?e.ui.registry.addButton("instructure_external_button_clump",{title:V.more_external_tools,image:"/images/downtick.png",onAction:t}):e.addButton("instructure_external_button_clump",{title:V.more_external_tools,image:"/images/downtick.png",onkeyup(e){if(32===e.keyCode||13===e.keyCode){e.stopPropagation()
t.call(this)}},onclick:t})}}}
function q(e,t){if(!t.iconSVG&&t.image){const e=document.createElement("svg")
...
t.icon="lti_tool_"+t.id}t.iconSVG&&e.ui.registry.addIcon(t.icon,t.iconSVG)}function M(e,t){t.length&&e.ui.registry.addNestedMenuItem("lti_tools_menuitem",{text:p.t("Apps"),icon:"lti",getSubmenuItems:()=>W(e,t)})}function H(e,t){const i=p.t("Apps")
e.ui.registry.addButton("lti_tool_dropdown",{onAction:()=>{const e=new CustomEvent("tinyRCE/onExternalTools",{detail:{ltiButtons:t}})
document.dispatchEvent(e)},icon:"lti",tooltip:i,onSetup(t){k.showHideButtons(e)}})}function G(e,t){t.forEach(t=>{if(!t.favorite)return
q(e,t)
e.ui.registry.addButton("instructure_external_button_"+t.id,{onAction:t.onAction,tooltip:t.title,icon:t.icon,title:t.title})})}function U(e,t){const i=p.t("Apps")
e.ui.registry.addMenuButton("lti_mru_button",{tooltip:i,icon:"lti",fetch(i){i(W(e,t))},onSetup(t){k.showHideButtons(e)}})}function W(e,t){const i=[]
...
i.push(t.menuItem)})
i.sort((e,t)=>e.text.localeCompare(t.text))}}catch(e){console.log("Failed building mru menu",e.message)}finally{i.push({type:"menuitem",text:p.t("View All"),onAction:()=>{const e=new CustomEvent("tinyRCE/onExternalTools",{detail:{ltiButtons:t}})
document.dispatchEvent(e)}})}return i}var K=I
function J(e={}){const t=["equationCB","linksCB","imagePickerCB","equellaCB","externalToolCB","recordCB"]
t.forEach(t=>{void 0===e[t]&&(e[t]=function(){})})
document.addEventListener("tinyRCE/initEquation",({detail:t})=>{Promise.all([i.e(7),i.e(2353)]).then(i.bind(null,"dIBj")).then(({default:i})=>{const r=new i(t.ed)
e.equationCB(r)})})
document.addEventListener("tinyRCE/initLinks",({detail:t})=>{N.renderDialog(t.ed)
e.linksCB()})
document.addEventListener("tinyRCE/initImagePicker",t=>{Promise.all([i.e(1),i.e(7),i.e(8),i.e(9),i.e(23),i.e(82),i.e(77),i.e(88),i.e(2299)]).then(i.bind(null,"FfTR")).then(({default:i})=>{const r=new i(t.detail.ed,t.detail.selectedNode)
e.imagePickerCB(r)})})
document.addEventListener("tinyRCE/initEquella",t=>{i.e(4115).then(i.bind(null,"IOhY")).then(({default:i})=>{i(t.detail.ed)
e.equellaCB()})})
document.addEventListener("tinyRCE/initExternalTools",t=>{K.init(t.detail.ed,t.detail.url,c["a"])
e.externalToolCB()})
document.addEventListener("tinyRCE/initRecord",t=>{Promise.all([i.e(43),i.e(4116)]).then(i.bind(null,"lUrZ")).then(({default:i})=>{i.insertEditor(t.detail.ed)
e.recordCB()})})}const Y={call(e,...t){if("exists?"===e)return true
...
const Q={wrapEditor(e){const t=Object(r["a"])(Object(r["a"])({},Y),e)
return Object.assign(e,t)},wrapSidebar(e){const t=Object(r["a"])(Object(r["a"])({},Z),e)
return Object.assign(e,t)}}
var X=Q
var ee=i("eVns")
var te=i("stQK")
let ie
const re={preload(e){(window.requestIdleCallback||window.setTimeout)(()=>this.loadRCE(e))},loadOnTarget(e,t,i){const r=this.getTargetTextarea(e)
const a=this.getRenderingTarget(r,t.getRenderingTarget)
const n=this.createRCEProps(r,t)
this.loadRCE(e=>{e.renderIntoDiv(a,n,e=>{e.mceInstance().on("init",()=>i(r,X.wrapEditor(e)))})})},loadSidebarOnTarget(e,t){if(ENV.RICH_CONTENT_SKIP_SIDEBAR)return
const i=Object(ee["a"])()
this.loadRCE(r=>{r.renderSidebarIntoDiv(e,i,e=>{t(X.wrapSidebar(e))})})},loadingCallbacks:[],RCE:null,loadRCE(e=(()=>{})){ie||(ie=(window.ENV.use_rce_enhancements?Promise.all([i.e(1),i.e(3),i.e(4),i.e(5),i.e(6),i.e(9),i.e(10),i.e(12),i.e(18),i.e(19),i.e(24),i.e(36),i.e(40),i.e(59),i.e(66),i.e(73),i.e(72),i.e(85),i.e(1973)]).then(i.bind(null,"j/Fk")):Promise.all([i.e(1),i.e(3),i.e(4),i.e(5),i.e(10),i.e(11),i.e(12),i.e(19),i.e(24),i.e(27),i.e(36),i.e(40),i.e(66),i.e(64),i.e(83),i.e(1974)]).then(i.bind(null,"dHiD"))).then(e=>{this.RCE=e
J()
return e}))
return ie.then(()=>{this.loadingCallbacks.forEach(e=>e(this.RCE))
...
return e},{})
return s.a.pick(i,t)},createRCEProps(e,t){var i,a,n,o,s,l
const c=e.offsetWidth
const d=e.offsetHeight||400
d&&(t.tinyOptions=Object(r["a"])({height:d},t.tinyOptions||{}))
const u=ENV.LOCALE
const _=Object.keys(te["a"]).map(e=>({id:e,label:te["a"][e]})).sort((e,t)=>e.id===u?-1:t.id===u?1:e.label.localeCompare(t.label,u))
...
return{defaultContent:e.value||t.defaultContent,editorOptions:h.bind(null,c,e.id,t,null),language:ENV.LOCALE,mirroredAttrs:this._attrsToMirror(e),onFocus:t.onFocus,onBlur:t.onBlur,textareaClassName:e.className,textareaId:e.id,trayProps:Object(ee["a"])(),languages:_,liveRegion:()=>document.getElementById("flash_screenreader_holder"),ltiTools:null===(i=window.INST)||void 0===i?void 0:i.editorButtons,autosave:g,instRecordDisabled:ENV.RICH_CONTENT_INST_RECORD_TAB_DISABLED,highContrastCSS:null===(a=window.ENV)||void 0===a?void 0:a.url_for_high_contrast_tinymce_editor_css,use_rce_pretty_html_editor:!!(null!==(n=window.ENV)&&void 0!==n&&null!==(o=n.FEATURES)&&void 0!==o&&o.rce_pretty_html_editor),use_rce_buttons_and_icons:!!(null!==(s=window.ENV)&&void 0!==s&&null!==(l=s.FEATURES)&&void 0!==l&&l.rce_buttons_and_icons)}}}
t["a"]=re},eVns:function(e,t,i){"use strict"
i.d(t,"a",(function(){return s}))
var r=i("ODXe")
var a=i("BrAc")
function n(e){let t=e
let i=null
return e=>{null===i&&(i=a["a"].post("/api/v1/jwts/refresh",{jwt:t}).then(e=>{i=null
t=e.data.token
return t}))
"function"===typeof e&&i.then(e)
return i}}var o=i("s9Pr")
function s(){if(!ENV.context_asset_string)return null
let e=Object(o["a"])(ENV.context_asset_string,false),t=Object(r["a"])(e,2),i=t[0],a=t[1]
const s=ENV.current_user_id
const l={contextType:i,contextId:a,userId:s}
const c=!ENV.use_rce_enhancements||ENV.RICH_CONTENT_CAN_UPLOAD_FILES
if(!c||"account"===i){a=s
i="user"}return{canUploadFiles:ENV.RICH_CONTENT_CAN_UPLOAD_FILES,containingContext:l,contextType:i,contextId:a,filesTabDisabled:ENV.RICH_CONTENT_FILES_TAB_DISABLED,host:ENV.RICH_CONTENT_APP_HOST,jwt:ENV.JWT,refreshToken:n(ENV.JWT),themeUrl:ENV.active_brand_config_json_url}}}}])

//# sourceMappingURL=21-c-889a0c8eb6.js.map